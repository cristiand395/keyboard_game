    ...
    <main className="grow flex flex-col items-center px-8 py-16 max-w-7xl mx-auto w-full">
      ...
      <section className="w-full mb-16 animate-rise text-center md:text-left">
        <div className="flex items-center justify-center md:justify-start gap-3 text-secondary mb-4">
          ...
          <span className="font-display text-[10px] font-bold tracking-[0.4em] uppercase">Módulos de aprendizaje</span>
        </div>
        <h1 className="text-5xl md:text-7xl font-display font-extrabold tracking-tight text-foreground mb-6 uppercase">
          Mejora tus <span className="text-secondary italic">Habilidades</span>
        </h1>
      ...
      <div className="w-full grid gap-6 lg:grid-cols-3 animate-rise" style={{ animationDelay: "150ms" }}>
        {tutorials.map((tutorial, index) => (
          <div 
            key={tutorial.slug}
            className="group bg-surface-low border border-white/5 rounded-lg p-8 flex flex-col hover:bg-surface-high hover:border-secondary/30 transition-all relative overflow-hidden shadow-sm"
          >
            {/* Background Accent */}
            ...
            <div className="mb-8">
              <Badge className="font-mono text-secondary bg-secondary/10 border border-secondary/20 tracking-widest leading-none mb-4 uppercase">
            ...
            <div className="mt-auto pt-8 border-t border-white/5 flex items-center justify-between">
               <div className="flex flex-col">
                  <span className="text-[9px] font-mono text-muted-foreground tracking-widest opacity-50 uppercase">Tiempo estimado</span>
                  <span className="text-xs font-display font-bold text-foreground uppercase">05:00 Min</span>
               </div>
